...
CREATE TABLE IF NOT EXISTS silver.valid_line_item_prices
AS SELECT * FROM public.line_item_prices_raw WITH NO DATA;

CREATE TABLE IF NOT EXISTS silver.invalid_line_item_prices
AS SELECT * FROM public.line_item_prices_raw WITH NO DATA;
